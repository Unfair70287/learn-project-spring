...
<br>
                ...
                <div class="row">
                    ...
                    <div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="teamo-custommenu default">
                            ...
                            <ul class="menu">
                                ...
                                <li class="menu-item"><a href="#">隱私權政策
                                    </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4 hidden-xs">
                        <div class="teamo-newsletter style1">
                            ...
                            <div class="newsletter-form-wrap">
                                <div class="list">馬上註冊獲取更多免費課程<br />以及最新活動消息
                                </div><input type="email" class="input-text email email-newsletter"
                                    placeholder="輸入你的信箱"><button
                                    class="button btn-submit submit-newsletter">訂閱我們</button>
                            </div>
                        </div>
                    </div>
                    <div class="box-footer col-xs-12 col-sm-4 col-md-4 col-lg-4">
                ...
                <div class="footer-end">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <div class="coppyright">Copyright © 2020 <a href="http://www.bootstrapmb.com/"> Good Student</a>.
    ...
    <div class="footer-device-mobile">
        <div class="wapper">
            ...
            <div class="footer-device-mobile-item device-home device-user"><a href="login.html"><span class="icon"><i
