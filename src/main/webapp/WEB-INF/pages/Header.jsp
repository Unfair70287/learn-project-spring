            ...
            <div class="container">
                ...
                <div class="top-bar-right">
                    ...
                    <ul class="header-user-links">
                        <li><a href="login.html">登入</a>   |   <a href="login.html">註冊</a></li>
                        <li></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="main-header1">
                <div class="row1">
                    <div class="col-lg-3 col-sm-4 col-md-3 col-xs-7 col-ts-12 header-element">
                        <div class="logo"><a href="Index.jsp"><img src="./images/logo.png" alt="img" width="175px" height="150px" ></a></div>
                    </div>
                    ...
                    <div class="col-lg-2 col-sm-12 col-md-3 col-xs-12 col-ts-12">
                        <div class="header-control">
                            ...
                            <div class="block-account block-header teamo-dropdown"><a href="javascript:void(0);"
                                    data-teamo="teamo-dropdown"><span class="flaticon-user"></span></a>
                                <div class="header-account teamo-submenu">
                                    <div class="header-user-form-tabs">
                                        </div>
                                    </div>
                                </div>
                            </div><a class="menu-bar mobile-navigation menu-toggle"
                ...
                <div class="header-nav-wapper main-menu-wapper">
                    <div class="vertical-wapper block-nav-categori">
                        <div class="block-title"><span
                                class="icon-bar"><span></span><span></span><span></span></span><span
                                class="text">全部分類</span></div>
                        <div class="block-content verticalmenu-content">
                            <ul class="teamo-nav-vertical vertical-menu teamo-clone-mobile-menu">
                                <li class="menu-item"><a href="#" class="teamo-menu-item-title"
                                        title="New Arrivals">我的學習</a></li>
                                <li class="menu-item"><a title="Hot Sale" href="#"
                                        class="teamo-menu-item-title">我的試卷</a></li>
                                <li class="menu-item "><a title="Accessories" href="#"
                                        class="teamo-menu-item-title">我的活動</a><span class="toggle-submenu"></span>
                                </li>
